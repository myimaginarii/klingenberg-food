...
select is(
  ...
  '{"dish": 1, "weekly": 1, "monthly": 0, "news": 1}'::jsonb,
...
select is(
  ...
  '{"dish": 1, "weekly": 0, "monthly": 1, "news": 1}'::jsonb,
...
select is(
  ...
  '{"live": {"dish": 0, "weekly": 0, "monthly": 0, "news": 0},
    "draft": {"dish": 0, "weekly": 0, "monthly": 0, "news": 0}}'::jsonb,
