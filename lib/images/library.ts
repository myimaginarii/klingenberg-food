 ...
 * Mad ud af huset's one (phase 11B) or Om os's three (phase 14B1) names the image by id. Nothing is ever inferred from a
...
export type ImageUsage = {
  readonly kind: 'dish' | 'weekly' | 'monthly' | 'news' | 'page:home' | 'page:takeaway' | 'page:about'
