...
| — (none supplied) | The licensed static map | **The one real remaining launch blocker** — the guard refuses a Vercel production build without it (`lib/site/map-launch-guard.ts`) |
