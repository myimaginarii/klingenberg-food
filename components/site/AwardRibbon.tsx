...
export function AwardRibbon() {
  return (
    <p className="border-brand-700 bg-surface text-brand-700 inline-flex items-center gap-3 self-start rounded-badge border py-1.5 pr-4 pl-1.5 text-meta font-semibold md:text-[0.875rem]">
      <span
        aria-hidden="true"
        className="border-brand-700 font-display flex size-8 shrink-0 items-center justify-center rounded-full border-[1.5px] text-[0.8125rem] font-bold"
      >
        4
      </span>
      <span>
